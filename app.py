...
df= pd.read_csv(r'C:\\Users\\YMTS0519\\Documents\\Disease Gene\\data.tsv', sep='\t')
...
def training():
    ...
    if request.method== 'POST':
        ...
        if model== 1:
            ...
            lgcr = accuracy_score(y_test, pred2)
            ...
            kncr = accuracy_score(y_test, pred3)
            ...
            svcr = accuracy_score(y_test, pred4)
